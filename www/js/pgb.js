...
$(document).ready(function() {
  ...
  function updateTime() {
    ...
    if (working) {
      ...
      audioWork(working, time_remaining, completed, a, b);
      ...
      mins = Math.floor(time_remaining/60);
      seconds = time_remaining - mins*60;
      audioBreak(working, time_remaining, completed, a, b);
...
setInterval(function() {
  ...
  $(".btntosetalrm").click(function(){
   ...
   function audioWork(working, time_left, progress, a, b){
   ...
   function audioBreak(working, time_left, progress, a, b){
